...
export const zhHans: Partial<Messages> = {
  ...
  "pet.menu.startTraining": "开始训练",
  "pet.menu.pauseAgentFollow": "暂停跟随 Agent",
  "pet.menu.hideUntilActivity": "隐藏至下次活动",
  "companion.status.working": "工作中",
  "companion.status.waiting": "等待中",
  "companion.status.review": "待查看",
  "companion.status.failed": "出错",
  "companion.badge.label": "{status}，{count} 条活动",
  "companion.tray.label": "Agent 活动",
  "companion.dismiss": "移除 {name}",
  "companion.age.now": "刚刚",
  "companion.request.permission": "权限请求",
  "companion.request.question": "问题",
  "companion.request.review": "待审阅",
  "companion.request.openLink": "打开链接",
  "companion.request.stop": "停止请求",
  "companion.request.continue": "继续请求",
  "companion.action.available": "可用操作",
  "companion.action.returnToAgent": "回到 Agent",
  "companion.action.openTask": "打开",
  "companion.action.stopTask": "停止",
  "companion.action.respond": "回复",
  "companion.action.send": "发送",
  "companion.action.voice": "语音",
  "companion.action.messagePlaceholder": "简短消息",
  "companion.action.failed": "操作失败",
