...
export const zhHant: Partial<Messages> = {
  ...
  "companion.status.failed": "出錯",
  "companion.badge.label": "{status}，{count} 條活動",
  "companion.tray.label": "Agent 活動",
  "companion.dismiss": "移除 {name}",
  "companion.age.now": "剛剛",
  "companion.request.permission": "權限請求",
  "companion.request.question": "問題",
  "companion.request.review": "待審閱",
  "companion.request.openLink": "開啟連結",
  "companion.request.stop": "停止請求",
  "companion.request.continue": "繼續請求",
  "companion.action.available": "可用操作",
  "companion.action.returnToAgent": "回到 Agent",
  "companion.action.openTask": "開啟",
  "companion.action.stopTask": "停止",
  "companion.action.respond": "回覆",
  "companion.action.send": "傳送",
  "companion.action.voice": "語音",
  "companion.action.messagePlaceholder": "簡短訊息",
  "companion.action.failed": "操作失敗",
