...
const TASK_MANIFESTS: Readonly<Record<BrainPetTaskId, BrainPetTaskManifest>> = {
  "cargo-signal": { apiVersion: 1, id: "cargo-signal", title: "装箱，还是放过", introRule: "蓝印装箱，红印放过", durationMs: 45_000, supportsSeed: true, taskVersion: "1.1.0", assetVersion: "1.0.0", scoring: { version: "brainpet-score-v1", correctPoints: 100, incorrectPoints: -40 }, difficulty: { policyVersion: "brainpet-block-v1", parameterVersion: "1.1.0", maxLevel: 10, blockCount: 3, passAccuracy: 0.75, minimumCorrect: 6 } },
  "pack-refresh": { apiVersion: 1, id: "pack-refresh", title: "行囊不重样", introRule: "记住行囊，找出刚移出的物品", durationMs: 45_000, supportsSeed: true, taskVersion: "1.2.0", assetVersion: "1.1.0", scoring: { version: "brainpet-score-v1", correctPoints: 140, incorrectPoints: -35 }, difficulty: { policyVersion: "brainpet-block-v1", parameterVersion: "1.1.0", maxLevel: 10, blockCount: 3, passAccuracy: 0.75, minimumCorrect: 4 } },
